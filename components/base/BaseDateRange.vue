<template>
  <div class="flex flex-col gap-4 lg:flex-row">
    <div class="flex flex-none gap-2">
      <UButton size="sm" :color="lastNDays === 7 ? 'primary' : 'white'" @click="setLastNDays(7)"> Last 7 days </UButton>
      <UButton size="sm" :color="lastNDays === 30 ? 'primary' : 'white'" @click="setLastNDays(30)">
        Last 30 days
      </UButton>
      <UButton size="sm" :color="lastNDays === 365 ? 'primary' : 'white'" @click="setLastNDays(365)">
        Last year
      </UButton>
      <UButton size="sm" :color="lastNDays === 3650 ? 'primary' : 'white'" @click="setLastNDays(3650)">
        Last 10 years
      </UButton>
      <UButton size="sm" :color="showCustom ? 'primary' : 'white'" @click="showCustom = true"> Custom </UButton>
