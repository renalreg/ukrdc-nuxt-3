<template>
  <!-- Wrapper div must be positioned to give popover something to position itself relative to.
  Without doing this, the popover will be positioned relative to the first positioned parent,
